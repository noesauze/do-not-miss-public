        ...
        ZStack {
            ...
            VStack(spacing: 22) {
                ...
                Text(viewModel.resolvedTitle)
                    ...
                    .accessibilityLabel(L10n.tr("Event title: %@", viewModel.resolvedTitle))

                Text(viewModel.formattedStartTime)
                    .font(.system(size: 20, weight: .medium, design: .rounded))
                    .foregroundStyle(Color.white.opacity(0.88))
                    .accessibilityLabel(L10n.tr("Starts at %@", viewModel.formattedStartTime))
                ...
                VStack(spacing: 10) {
                    HStack(spacing: 10) {
                        actionButton(
                            title: L10n.tr("overlay.action.join_now"),
                            action: viewModel.joinNowTapped,
                            isPrimary: true,
                            isEnabled: viewModel.joinActionAvailability.isEnabled
                        )
                        .keyboardShortcut(.defaultAction)
                        .accessibilityLabel(Text(L10n.tr("overlay.accessibility.join_video_call")))

                        actionButton(
                            title: L10n.tr("overlay.action.snooze"),
                ...
                .accessibilityLabel(Text(L10n.tr("overlay.accessibility.close")))
            }
